...
banner() {
  ...
  printf "%b\n" "${C_PURPLE}${C_BOLD}║${C_RESET}  ${C_TEAL}SPIDER orchestration for TRUSTED AI SOC LITE · Use --help for options · Stay lethal 🕷️${C_RESET} ${C_PURPLE}${C_BOLD}║${C_RESET}"
  printf "%b\n" "${bottom}"

  printf "%b   [>] Launcher:%b ${hello_word} orchestrator · Debian native\n" "${C_TEAL}${C_BOLD}" "${C_RESET}"
